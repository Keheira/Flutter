...
class StoryBrain {
  ...
  String getStory() {
    return _storyData[_qnum].title;
  }

  String getChoice1() {
    return _storyData[_qnum].choice1;
  }

  String getChoice2() {
    return _storyData[_qnum].choice2;
  }

  void nextStory(int choice) {
    if (_qnum == 3 || _qnum == 4 || _qnum == 5)
      restart();
    else if (_qnum == 0 && choice == 1)
      _qnum = 2;
    else if (_qnum == 0 && choice == 2)
      _qnum = 1;
    else if (_qnum == 1 && choice == 1)
      _qnum = 2;
    else if (_qnum == 1 && choice == 2)
      _qnum = 3;
    else if (_qnum == 2 && choice == 1)
      _qnum = 5;
    else
      _qnum = 4;
  }
